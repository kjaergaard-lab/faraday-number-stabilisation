...
#
# Generated by Vivado on Wed Jul 01 15:45:23 +1200 2020
...
set_property -name "top" -value "UART_Receiver_tb" -objects $obj
...
if { [get_files PowDivider.xci] == "" } {
  import_files -quiet -fileset sources_1 E:/Projects/dispersive-probe-feedback/fpga/rp-feedback.srcs/sources_1/ip/PowDivider/PowDivider.xci
}
...
if { [get_files UART_Receiver.vhd] == "" } {
  import_files -quiet -fileset sources_1 E:/Projects/dispersive-probe-feedback/fpga/vhdl-sources/UART_Receiver.vhd
}
